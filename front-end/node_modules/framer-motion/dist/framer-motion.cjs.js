...
function createLifecycles() {
    ...
    managers.forEach(function (manager, i) {
        ...
        lifecycles["notify" + names[i]] = function () {
            ...
            return manager.notify.apply(manager, tslib.__spread(args));
        };
    });
    return lifecycles;
}
...
function createDomMotionConfig(defaultFeatures, Component, forwardMotionProps) {
    var baseConfig = isSVGComponent(Component)
        ? svgMotionConfig
        : htmlMotionConfig;
    return tslib.__assign(tslib.__assign({}, baseConfig), { defaultFeatures: defaultFeatures, useRender: createUseRender(Component, forwardMotionProps) });
}
